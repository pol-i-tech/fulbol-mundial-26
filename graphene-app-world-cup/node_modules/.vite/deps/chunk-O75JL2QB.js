// node_modules/@graphenedata/html2canvas/dist/html2canvas.esm.js
    ...
    function ElementContainer2(context, element) {
      ...
      if (isHTMLElementNode(element)) {
        if (this.styles.animationDuration.some(function(duration2) {
          ...
          this.context.applyTemporaryStyle(element, "animationDuration", "0s");
        }
        if (this.styles.transform !== null) {
          this.context.applyTemporaryStyle(element, "transform", "none");
        }
      }
...
var Context = (
  ...
  (function() {
    ...
    Context2.prototype.applyTemporaryStyle = function(element, property, value) {
    ...
    Context2.prototype.cleanup = function() {
...
var renderElement = function(element, opts) {
  return __awaiter(void 0, void 0, void 0, function() {
    var ownerDocument, defaultView, resourceOptions, useLiveDOM, contextOptions, windowOptions, windowBounds, context, foreignObjectRendering, cloneOptions, container, clonedElement, documentCloner, referenceElement, _a, width, height, left, top, backgroundColor2, renderOptions, canvas, renderer, root, renderer;
    ...
    return __generator(this, function(_w) {
      switch (_w.label) {
        case 0:
          ...
          useLiveDOM = (_f = (_e = opts.useLiveDOM) !== null && _e !== void 0 ? _e : opts.liveDOM) !== null && _f !== void 0 ? _f : false;
          contextOptions = __assign({ logging: (_g = opts.logging) !== null && _g !== void 0 ? _g : true, cache: opts.cache, liveDOM: useLiveDOM }, resourceOptions);
          windowOptions = {
            windowWidth: (_h = opts.windowWidth) !== null && _h !== void 0 ? _h : defaultView.innerWidth,
            windowHeight: (_j = opts.windowHeight) !== null && _j !== void 0 ? _j : defaultView.innerHeight,
            scrollX: (_k = opts.scrollX) !== null && _k !== void 0 ? _k : defaultView.pageXOffset,
            scrollY: (_l = opts.scrollY) !== null && _l !== void 0 ? _l : defaultView.pageYOffset
          };
          windowBounds = new Bounds(windowOptions.scrollX, windowOptions.scrollY, windowOptions.windowWidth, windowOptions.windowHeight);
          context = new Context(contextOptions, windowBounds);
          foreignObjectRendering = (_m = opts.foreignObjectRendering) !== null && _m !== void 0 ? _m : false;
          cloneOptions = {
            allowTaint: (_o = opts.allowTaint) !== null && _o !== void 0 ? _o : false,
          ...
          container = null;
          if (!useLiveDOM) return [3, 3];
          context.logger.debug("Skipping document clone, rendering element directly with viewport " + windowBounds.width + "x" + windowBounds.height);
          clonedElement = element;
          if (!(typeof cloneOptions.onclone === "function")) return [3, 2];
          return [4, Promise.resolve(cloneOptions.onclone(ownerDocument, clonedElement))];
        case 1:
          _w.sent();
          _w.label = 2;
        case 2:
        ...
        case 3:
          ...
          referenceElement = documentCloner.clonedReferenceElement;
          if (!referenceElement) {
        ...
        case 5:
          ...
          renderOptions = {
            ...
            scale: (_q = (_p = opts.scale) !== null && _p !== void 0 ? _p : defaultView.devicePixelRatio) !== null && _q !== void 0 ? _q : 1,
            x: ((_r = opts.x) !== null && _r !== void 0 ? _r : 0) + left,
            y: ((_s = opts.y) !== null && _s !== void 0 ? _s : 0) + top,
            width: (_t = opts.width) !== null && _t !== void 0 ? _t : Math.ceil(width),
            height: (_u = opts.height) !== null && _u !== void 0 ? _u : Math.ceil(height)
          };
          _w.label = 6;
        case 6:
          _w.trys.push([6, , 11, 12]);
          if (!foreignObjectRendering) return [3, 8];
          context.logger.debug((useLiveDOM ? "Rendering live DOM" : "Document cloned") + ", using foreign object rendering");
        ...
        case 7:
          ...
          return [3, 10];
        case 8:
          context.logger.debug((useLiveDOM ? "Rendering live DOM" : "Document cloned") + ", element located at " + left + "," + top + " with size " + width + "x" + height + " using computed rendering");
        ...
        case 10:
          ...
          return [2, canvas];
        case 11:
          if (!useLiveDOM && ((_v = opts.removeContainer) !== null && _v !== void 0 ? _v : true) && container) {
...
//# sourceMappingURL=chunk-O75JL2QB.js.map

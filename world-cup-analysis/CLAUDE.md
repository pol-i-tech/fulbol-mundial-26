# CLAUDE.md — `world-cup-analysis`

Entry point for Claude Code (and any AI agent) doing analysis work in this folder. Kept identical in substance to [`AGENTS.md`](./AGENTS.md) by convention.

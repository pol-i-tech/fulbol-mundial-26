# Model Card: curated-poisson-luck

| Field | Value |
|---|---|
| **Model name** | curated-poisson-luck |
...
| **Output location** | `results/curated-poisson-luck/<YYYY-MM-DD>/predictions.csv` (group-stage 1X2) + `results/curated-poisson-luck/<YYYY-MM-DD>/probabilities.csv` (tournament Monte Carlo). |
